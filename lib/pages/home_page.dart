...
import '../widgets/first_search_filters_row.dart';
import '../widgets/second_search_filters_row.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Expanded firstSearchEntriesRow() {
    return Expanded(
      child: ListView(
  ...
  Expanded secondSearchEntriesRow() {
    return Expanded(
      child: ListView(
        scrollDirection: Axis.horizontal,
        children: [
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ref.read(searchValuesProvider.notifier).update(searchValues);
